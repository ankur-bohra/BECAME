...
CUDA_VISIBLE_DEVICES=$1 python -u main_swag.py --gpuid $GPUID --reg_coef 100 \
    ...
    --merge_method swag --swag_start 15 --swag_collect_freq 1
...
#     --dataset CIFAR100 --repeat $REPEAT \
#     --model_optimizer SGDSVD --model_name resnet18 --model_type resnet \
#     --schedule 1 2 3 --force_out_dim 0 \
#     --first_split_size 10 --other_split_size 10 --batch_size 4 \
#     --merge_list 3 --early_stop --patience 3 \
#     --decay_time 2 --gamma 0.5 --momentum 0.9 --nesterov \
#     --merge_method swag --swag_start 2 --swag_collect_freq 1